...
public class DodgeballBall extends AbstractPhysicalEntity implements IBullet, IMustRemainInArena {
	...
	public DodgeballBall(MultiplayerVoxelWorldMain _game, GameModule _module, ICanShoot _shooter) {
	...
	public static Geometry getBall(MultiplayerVoxelWorldMain game) {
