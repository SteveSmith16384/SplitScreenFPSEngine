...
public class Rocket extends AbstractPhysicalEntity implements IBullet {

	public ICanShoot shooter;

	public Rocket(MultiplayerVoxelWorldMain _game, GameModule _module, ICanShoot _shooter) {
