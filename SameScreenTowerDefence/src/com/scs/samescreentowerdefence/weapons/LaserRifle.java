...
import com.scs.samescreentowerdefence.entities.LaserBullet;

public class LaserRifle extends AbstractMagazineGun implements IAbility {

	public LaserRifle(MultiplayerVoxelWorldMain _game, AbstractGameModule _module, ICanShoot shooter) {
		super(_game, _module, "Laser Rifle", shooter, .2f, 2, 10);
	}

	
	@Override
	public void launchBullet(MultiplayerVoxelWorldMain game, AbstractGameModule module, ICanShoot _shooter) {
